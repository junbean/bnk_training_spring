...
import com.example.demo.service.CulturalPropertyService;
...
public class MyController {
    ...
    private final CulturalPropertyService culturalPropertyService;

    public MyController(CulturalPropertyService culturalPropertyService) {
        this.culturalPropertyService = culturalPropertyService;
    }

	@GetMapping("/")
	public String root(Model model) throws IOException {
		// 서비스 사용
		// List<CulturalProperty> properties = culturalPropertyService.fetchCulturalProperties();
	    
		List<CulturalProperty> properties = fetchCulturalProperties();
